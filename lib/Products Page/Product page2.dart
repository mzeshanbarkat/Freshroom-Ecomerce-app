...
class product2 extends StatefulWidget {
  static String id = 'Product page2';
                      ...
                      Expanded(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            // color: Colors.amber,
                            borderRadius: BorderRadius.only(topLeft: Radius.circular(10),topRight: Radius.circular(10),),
                            image: DecorationImage(image: AssetImage('assets/bed.jpg'),fit: BoxFit.fill),
                          ),
                        ),),
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('Furniture',style: Textt2.textStyle(kprimarycolor, 15),),

                              Text('Double Bed',style: Textt2.textStyle(ksecondarycolor, 25),),

                              Padding(
                                padding: const EdgeInsets.only(top: 30),
                                child: Row(
                                  children: [
                                    Text('\u0024 784',style: Textt2.textStyle(ktertiarycolor, 20),),

                                    Padding(
                                      padding: const EdgeInsets.only(left: 20),
                                      child: Text('5.0 ',style: Textt2.textStyle(ksecondarycolor, 15),),
                                    ),
                                    ...
                                    Text('   8k reviews',style: Textt2.textStyle(kprimarycolor, 15),),
