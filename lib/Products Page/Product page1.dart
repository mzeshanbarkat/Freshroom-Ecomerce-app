...
class product1 extends StatefulWidget {
  static String id = 'Product page1';
  @override
                      ...
                      Expanded(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            // color: Colors.amber,
                            borderRadius: BorderRadius.only(topLeft: Radius.circular(10),topRight: Radius.circular(10),),
                            image: DecorationImage(image: AssetImage('assets/3seater.jpg'),fit: BoxFit.fill),
                          ),
                      ),),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('3 Seater Sofa',style: Textt2.textStyle(ksecondarycolor, 25),),

                              Padding(
                                padding: const EdgeInsets.only(top: 30),
                                child: Row(
                                  children: [
                                    Text('\u0024 128',style: Textt2.textStyle(ktertiarycolor, 20),),
