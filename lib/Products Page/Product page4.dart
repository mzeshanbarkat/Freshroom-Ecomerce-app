...
class product4 extends StatefulWidget {
  static String id = 'Product page4';
  @override
  _product4State createState() => _product4State();
}
                      ...
                      Expanded(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            // color: Colors.amber,
                            borderRadius: BorderRadius.only(topLeft: Radius.circular(10),topRight: Radius.circular(10),),
                            image: DecorationImage(image: AssetImage('assets/dinerset.jpg'),fit: BoxFit.fill),
                          ),
                        ),),
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('Kitchen',style: Textt2.textStyle(kprimarycolor, 15),),

                              Text('Dinner Set',style: Textt2.textStyle(ksecondarycolor, 25),),

                              Padding(
                                padding: const EdgeInsets.only(top: 30),
                                child: Row(
                                  children: [
                                    Text('\u0024 99.99',style: Textt2.textStyle(ktertiarycolor, 20),),
